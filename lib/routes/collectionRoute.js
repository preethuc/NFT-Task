...
router.route("/:id").get(_collectionController2.default.collectionById).patch(_collectionController2.default.updateCollection).delete(_collectionController2.default.removeCollection);
