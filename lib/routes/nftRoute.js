...
router.route("/getHighestBid/").get(_nftController2.default.getHighestBid);

router.route("/buy/:id").put(_nftController2.default.updateBuy);
...
router.route("/addBidPrice").post(_nftController2.default.createBidPrice);
router.route("/getBidProcess").get(_nftController2.default.allBidProcess);
